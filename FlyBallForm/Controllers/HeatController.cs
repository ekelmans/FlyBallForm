    ...
    public class HeatController : ApiController
    {
        ...
        public string Post([FromBody]string value)
        {
            ...
            for (i = 0 ; i < rws.Length; i++)
            {
                ...
                SqlCommand com = new SqlCommand("insert into [dbo].[FlyFormHeat](HeatID, RaceID, HeatNr, BaanKleurID, TeamID, Tijd, ResultaatID, Punten, Hond1, Hond2, Hond3, Hond4, Hond5, Hond6, ChangeDT) values (@HeatID, @RaceID, @HeatNr, @BaanKleurID, @TeamID, @Tijd, @ResultaatID, @Punten, @Hond1, @Hond2, @Hond3, @Hond4, @Hond5, @Hond6, @ChangeDT)", con);
                ...
                com.Parameters.AddWithValue("@ChangeDT", DateTime.Now);
        ...
        public string Put(int id, [FromBody]string value)
        {
            ...
            SqlCommand com = new SqlCommand("update [dbo].[FlyFormHeat] set RaceID = @RaceID,HeatNr = @HeatNr,BaanKleurID= @BaanKleurID,TeamID = @TeamID,Tijd = @Tijd,ResultaatID= @ResultaatID,Punten = @Punten,Hond1 = @Hond1,Hond2 = @Hond2,Hond3 = @Hond3,Hond4 = @Hond4,Hond5 = @Hond5,Hond6 = @Hond6 where HeatID = @HeatID", con);
        ...
        private void ClearFlyFormHeat()
        {
            string conStr = ConfigurationManager.ConnectionStrings["FlyFormConnectionString"].ConnectionString;
            SqlConnection con = new SqlConnection(conStr);
            SqlCommand com = new SqlCommand("delete from [dbo].[FlyFormHeat]", con);
            con.Open();
            com.ExecuteNonQuery();
            con.Close();
        }
